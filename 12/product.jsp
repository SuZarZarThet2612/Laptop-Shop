...
<td width=726 class=right>24X7 customer Support -<a href="contant.jsp">Contant us</a> | <a href="main.js">Home</a> |
...
<input type="image" src="pimage/b4.png" name="buy" value="grand" width=50 height=50>
	<%} else {
		%>
			<p>
<form action="buy.jsp">
