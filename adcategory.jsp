...
<table width="993" height="102" border="0">
		<tr>
			...
			<td width="726" class="right">24x7 Customer Support- <a href="cantact1.jsp">Contact us</a> | <a href="admain.jsp">Home</a> |
...
%>
	...
	<%} %>
		...
		ps=con.prepareStatement("select * from mtable where prod_id=? ");
			...
			<p>Rs.<input type="text" name="p" value=<%=rs.getString(4)%> ></p> 
			<p> <input type="submit" value="Update"/>
<input type="hidden" name="id1" value=<%=rs.getString(1) %>   ></form>
<form action="addelete.jsp">
<p> <input type="submit" value="Delete"/>
<input type="hidden" name="id2" value=<%=rs.getString(1) %>   >
</form>
<% } %></p>
			</td></tr><%
